...
![Initial Commit.PNG](Screenshots%2FInitial%20Commit.PNG)
...
| ---------- |---------------------------------------|------------------------------------|
| `CarPark`    | parking_bays<br/>occupied_bays        | car_entry<br/>car_exits            |
| `Sensor`     | sensor_id<br/>temperature             | detect_car<br/>measure_temperature |
| `Display`    | display_id<br/>display_available_bays | display_status<br/>power_on        |
...
![Added stubs for classes.PNG](Screenshots%2FAdded%20stubs%20for%20classes.PNG)
...
![git tag.PNG](Screenshots%2Fgit%20tag.PNG)
...
![Failed unit test.png](Screenshots%2FFailed%20unit%20test.png)

![test_car_park - tests ok.PNG](Screenshots%2Ftest_car_park%20-%20tests%20ok.PNG)
...
![unit test for display - ok.PNG](Screenshots%2Funit%20test%20for%20display%20-%20ok.PNG)
...
> The method belongs to the CarPark class and is responsible for adding Sensor or Display. It's better to test it in the CarPark unit tests because it checks how these components are added to the CarPark.
...
![finished main.PNG](Screenshots%2Ffinished%20main.PNG)
...
![release.PNG](Screenshots%2Frelease.PNG)
